...
////// Emissive:
                ...
                half4 finalRGBA = half4(finalColor,((lerp(node_9847,_MainTex_var.a,i.uv2.a)*i.uv2.g)*i.vertexColor.a));
                UNITY_APPLY_FOG_COLOR(i.fogCoord, finalRGBA, half4(0.4,0.4235294,0.4431373,0.6039216));
                return finalRGBA;
            }
            ENDCG
        }
